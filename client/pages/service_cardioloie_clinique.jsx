...
const servicesData = [
  ...
  Examen rapide et indolore permettant d'enregistrer l'activité électrique du cœur pour détecter des anomalies du rythme cardiaque.
      `,
      logo:"/consultationr.png"
        },
  {
      title: "Échographie Doppler vasculaire",
      description:
      `
Cet examen non invasif permet d'évaluer la circulation sanguine dans les vaisseaux, notamment pour détecter des obstructions ou des anomalies du flux sanguin. `,    logo:"/consultationr.png"
        },
  {
   ...
   Utilisation du Doppler pour visualiser le cœur et évaluer son fonctionnement, en particulier pour diagnostiquer des problèmes des valves cardiaques, de la fonction ventriculaire ou des anomalies du flux sanguin.
      `,    logo:"/consultationr.png"
        },
        {
            ...
            description:
            `
        Surveillance ambulatoire de la pression artérielle sur 24 heures pour détecter l'hypertension ou des variations anormales de la pression.     `,    logo:"/consultationr.png"
              },
              {
                title: "Holter ECG",
                description:
...
Examen non invasif permettant de suivre l'état des vaisseaux et du cœur chez les enfants, notamment en cas de malformations cardiaques congénitales ou de pathologies vasculaires.
                     `,  logo:"/consultationr.png"
                      },
                      {
                        ...
                        description:
                        `
Test permettant d'évaluer la réponse du cœur à l'effort physique et de détecter des anomalies cardiaques sous stress, comme l'angine de poitrine ou des troubles du rythme.                         `,    logo:"/consultationr.png"
                          },
                          {
                            title: "Échographie d'effort",
                            description:
                            `
    Combinaison d'une épreuve d'effort avec une échographie cardiaque pour analyser le fonctionnement du cœur sous contrainte physique et évaluer la fonction cardiaque en temps réel.                       `,   logo:"/consultationr.png"
                              },
                              {
                                title: "Échographie transœsophagienne sous anesthésie générale (AG)",
                                description:
                                `
       Cet examen permet d’obtenir des images détaillées du cœur en introduisant une sonde par l'œsophage, sous anesthésie générale, pour des indications spécifiques comme la recherche de caillots ou des anomalies des valves cardiaques.  `,    logo:"/consultationr.png"
                                  },
];
